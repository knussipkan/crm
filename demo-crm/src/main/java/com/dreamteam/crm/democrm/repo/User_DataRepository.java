...
import com.dreamteam.crm.democrm.entity.User_Data;
 ...
 */
@Repository
public interface User_DataRepository extends JpaRepository<User_Data, Long> {
   List<User_Data> findUser_DataByUsername(@Param("username") String username);
