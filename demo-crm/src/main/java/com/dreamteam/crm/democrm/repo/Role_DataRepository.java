...
import com.dreamteam.crm.democrm.entity.Role_Data;
 ...
 */
@Repository
public interface Role_DataRepository extends JpaRepository<Role_Data, Long> {
   List<Role_Data> findRole_DataByName(@Param("name") String name);
